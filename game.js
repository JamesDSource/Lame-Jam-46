...
var ASM_CONSTS = {
  103696: () => { if (document.fullscreenElement) return 1; },  
 103742: () => { return document.getElementById('canvas').width; },  
 103794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103862: () => { document.exitFullscreen(); },  
 103889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103962: () => { if (document.fullscreenElement) return 1; },  
 104008: () => { return document.getElementById('canvas').width; },  
 104060: () => { return screen.width; },  
 104085: () => { document.exitFullscreen(); },  
 104112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104245: () => { return window.innerWidth; },  
 104271: () => { return window.innerHeight; },  
 104298: () => { if (document.fullscreenElement) return 1; },  
 104344: () => { return document.getElementById('canvas').width; },  
 104396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104464: () => { if (document.fullscreenElement) return 1; },  
 104510: () => { return document.getElementById('canvas').width; },  
 104562: () => { return screen.width; },  
 104587: () => { return window.innerWidth; },  
 104613: () => { return window.innerHeight; },  
 104640: () => { if (document.fullscreenElement) return 1; },  
 104686: () => { return document.getElementById('canvas').width; },  
 104738: () => { return screen.width; },  
 104763: () => { document.exitFullscreen(); },  
 104790: () => { if (document.fullscreenElement) return 1; },  
 104836: () => { return document.getElementById('canvas').width; },  
 104888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104956: () => { document.exitFullscreen(); },  
 104983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105041: () => { return screen.width; },  
 105066: () => { return screen.height; },  
 105092: () => { return window.screenX; },  
 105119: () => { return window.screenY; },  
 105146: () => { return window.devicePixelRatio; },  
 105182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105235: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105306: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105363: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105619: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105690: () => { if (document.fullscreenElement) return 1; },  
 105736: () => { return window.innerWidth; },  
 105762: () => { return window.innerHeight; },  
 105789: () => { if (document.pointerLockElement) return 1; }
};
